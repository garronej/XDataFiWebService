...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/WpfApplication1;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public double id
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.id;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.id = value;
			}
		}
	}
}
